...
const stackPrefix = "FSA";

const backendStack = new MainBackendStack(app, `${stackPrefix}BackendStack`, {
  env: {
...
const frontendStack = new MainFrontendStack(app, `${stackPrefix}FrontendStack`, {
  env: {
    account: process.env.CDK_DEFAULT_ACCOUNT,
